...
#define XGMAC_CONFIG_IPG		GENMASK(10, 8)
#define XGMAC_CONFIG_IPG_SHIFT		8
#define XGMAC_CONFIG_IFP		BIT(11)
#define XGMAC_CONFIG_ISR		GENMASK(7, 4)
#define XGMAC_CONFIG_ISR_SHIFT	4
#define XGMAC_CONFIG_ISM		BIT(3)
#define XGMAC_CONFIG_SARC		GENMASK(22, 20)
#define XGMAC_CONFIG_SARC_SHIFT	20
#define XGMAC_CONFIG_JD		BIT(16)
#define XGMAC_CONFIG_TE		BIT(0)
#define XGMAC_EXT_CONFIG_EIPG		GENMASK(6, 0)
#define XGMAC_EXT_CONFIG_EIPG_SHIFT	0
